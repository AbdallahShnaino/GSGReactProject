  ...
  return (
    <div className="Home-screen">
      ...
      <section className="landing-section">
        ...
        <div className="cta-half">
          ...
          <p className="cta-desc">
            ...
            invoices, as well as generating reports and sending notifications.
          </p>
      ...
      <section className="features-section">
        <div className="cta-img">
          <div className="img-cont" id="img2"></div>
        </div>
        <div className="features">
          <h3 className="desc-title">We offer the best services</h3>
          <p className="desc">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Distinctio
            dolore consectetur corrupti odio atque ipsa cupiditate sequi
            sapiente fuga soluta sed suscipit aut, ad dicta earum pariatur
            voluptates! Hic, laborum.
          </p>
          ...
          <Link className="cta-btn outlined" to={"/signup"}>
            Start Now
          </Link>
        </div>
      </section>
          ...
          <li className="step">
            <div className="step-icon">
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  <path
                    d="m45.2 19.6a1.6 1.6 0 0 1 1.59 1.45v22.55a4.82 4.82 0 0 1 
        ...
        <div className="reviews-container">
          <div className="review-card">
            <div className="avatar">
              <img
                src="https://t4.ftcdn.net/jpg/05/31/37/89/240_F_531378938_xwRjN9e5ramdPj2coDwHrwk9QHckVa5Y.jpg"
                alt="Avatar"
              />
            ...
            <p className="review">
              ...
              amet nulla auctor, vestib ullum magna. Praesent sit amet nulla
              auctor, vestibulum magna. Praes
            </p>
          </div>
          <div className="review-card">
            <div className="avatar">
          ...
          <div className="review-card">
            <div className="avatar">
              <img
                src="https://t3.ftcdn.net/jpg/03/02/88/46/240_F_302884605_actpipOdPOQHDTnFtp4zg4RtlWzhOASp.jpg"
                alt="Avatar"
              />
              <div className="avatar-data">
      ...
      <section className="contact-form">
        ...
        <p className="desc">
          ...
          repellendus, minima amet exercitationem at iure excepturi ipsum
          eligendi ipsam!
        </p>
